...
const SplashScreen = ({ onContinue }) => {
  // SET AI ASSISTANT SEBAGAI DEFAULT EXPANDED
  const [hoveredFeature, setHoveredFeature] = useState("ai-assistant");
  ...
  const features = [
    {
      ...
      description:
        "Generate dokumen ekspor, email bisnis profesional, dan estimasi biaya secara otomatis dengan teknologi AI terdepan",
      previewVideo: Fitur1,
    },
    {
      id: "shipping",
      ...
      description:
        "Kelola alur pengiriman, tracking real-time, dan manajemen dokumen ekspor dengan sistem terintegrasi",
      previewVideo: Fitur2,
    },
    {
      id: "trend",
      ...
      description:
        "Analisis tren pasar global, permintaan produk, dan insight bisnis untuk strategi ekspor yang tepat",
      previewVideo: Fitur3,
    },
  ];
  ...
  const handleFeatureLeave = () => {
    // JANGAN RESET KE NULL, BIARKAN TETAP EXPANDED
              ...
              >
                {features.map((feature, index) => (
                  <div key={feature.id}>
                    ...
                    >
                      {/* TITLE SECTION - TIDAK ADA BACKGROUND */}
                      <div
                      ...
                      {/* DETAIL SECTION - DENGAN BACKGROUND DAN BORDER MELENGKUNG */}
                      <div
                      ...
                      >
                        {/* CONTAINER DENGAN BACKGROUND DAN BORDER MELENGKUNG */}
                        <div
                          className="pb-8 px-4 mx-4 mb-4"
                          style={{
                            backgroundColor: "rgba(248, 250, 252, 0.8)", // bg-slate-50 dengan opacity
                            borderRadius: "20px", // border melengkung
                            border: "1px solid rgba(226, 232, 240, 0.6)", // border tipis
                            backdropFilter: "blur(10px)", // efek blur untuk modern look
                            boxShadow:
                        ...
                        >
                          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center pt-6">
                            ...
                            <div className="relative">
                              <div
                                className="aspect-video overflow-hidden shadow-sm bg-[var(--bg-primary)]"
                                style={{
                                  borderRadius: "16px", // border melengkung untuk video container
                              ...
                              >
                                ...
                                <video
                                  ...
                                  playsInline
                                  style={{
                                    borderRadius: "15px", // sedikit lebih kecil dari container
                                  }}
                                  onError={(e) => {
